...
has_scalar 'vtpVersion'        => ( oid => '1.1', );

has_scalar 'vtpMaxVlanStorage' => ( oid => '1.2', );

has_scalar 'vtpNotificationsEnabled'    => ( oid => '1.3', munger => 'munge_enabled');

has_scalar 'vtpVlanCreatedNotifEnabled' => ( oid => '1.4', munger => 'munge_enabled' );

has_scalar 'vtpVlanDeletedNotifEnabled' => ( oid => '1.5', munger => 'munge_enabled' );
